...
our $PROGVERSION = '1.19.4';
our $PROGMAKE = '/Applications/Xcode.app/Contents/Developer/usr/bin/gnumake';
our $PROGTAR = '/opt/local/bin/gnutar';
our $PROGPATCH = 'gpatch';

our $CONFDIR = '/opt/local/etc/dpkg';
our $ADMINDIR = '/opt/local/var/db/dpkg';
our $LIBDIR = '/opt/local/libexec/dpkg';
our $DATADIR = '/opt/local/share/dpkg';
